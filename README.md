...
[![CI](https://github.com/menot-you/mcp-asc/actions/workflows/ci.yml/badge.svg)](https://github.com/menot-you/mcp-asc/actions/workflows/ci.yml)
...
/plugin install mcp-asc
```

The install hook downloads `nott-asc` from the GitHub Release into `${CLAUDE_PLUGIN_ROOT}/bin/`.
